...
import {OutlineColor, outlineColorMap} from '../lib/colors.ts'
...
<template>
  <div class="wrapper text-8xl font-mono whitespace-pre cursor-default">
    <div class="upper">
      <span class="next bg-stone-800 outline-2 -outline-offset-2 px-6 py-4" :class="colorClass">
        {{ nextChar }}
      </span>
      <span class="current bg-stone-800 outline-2 -outline-offset-2 px-6 py-4" :class="[upperFlapAnimState, colorClass]">
        {{ currentChar }}
      </span>
    </div>
    <div class="bottom">
      <span class="next bg-stone-800 outline-2 -outline-offset-2 px-6 py-4" :class="[bottomFlapAnimState, colorClass]">
        {{ nextChar }}
      </span>
      <span class="current bg-stone-800 outline-2 -outline-offset-2 px-6 py-4" :class="colorClass">
        {{ currentChar }}
      </span>
    </div>
  </div>
